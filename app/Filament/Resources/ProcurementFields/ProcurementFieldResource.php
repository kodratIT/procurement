...
class ProcurementFieldResource extends Resource
{
    ...
    {
        return app(FeatureModuleService::class)->allowsResource(self::class, fn (User $user): bool => app(AuthorizationService::class)->allowsAcrossAssignments($user, 'ViewAny:ProcurementField'));
    }
