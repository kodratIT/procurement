...
class ProcurementVariantResource extends Resource
{
    ...
    {
        return $s->components([Select::make('item_id')->relationship('item', 'name')->searchable()->preload()->required(), TextInput::make('code')->required(), TextInput::make('name')->required(), TextInput::make('value'), Toggle::make('is_active')->default(true)]);
    }
