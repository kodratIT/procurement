...
class DepartureBatchResource extends Resource
{
    ...
    public static function form(Schema $s): Schema
    {
        return $s->components([
            ...
            Select::make('office_id')->relationship('office', 'name')->searchable()->preload()->label('Kantor Pemilik'),
            DatePicker::make('departure_date')->required(),
            DatePicker::make('return_date')->afterOrEqual('departure_date'),
            TextInput::make('capacity')->numeric()->minValue(1)->label('Kapasitas'),
            TextInput::make('pax_count')->numeric()->minValue(1)->label('Jumlah Jamaah'),
    ...
    public static function table(Table $t): Table
    {
        return $t->columns([
            ...
            TextColumn::make('office.name')->label('Kantor Pemilik')->searchable(),
            TextColumn::make('departure_date')->date()->sortable(),
            TextColumn::make('return_date')->date(),
            TextColumn::make('pax_count')->label('Jumlah Jamaah')->sortable(),
