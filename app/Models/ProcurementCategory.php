...
class ProcurementCategory extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'requires_recommendation_reason' => 'boolean',
            'requires_recommendation_evidence' => 'boolean',
    ...
    public function configuration(): ProcurementCategoryConfiguration
    {
        return new ProcurementCategoryConfiguration(
            ...
            requiresRecommendationReason: (bool) $this->requires_recommendation_reason,
            requiresRecommendationEvidence: (bool) $this->requires_recommendation_evidence,
