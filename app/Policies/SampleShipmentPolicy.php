...
final class SampleShipmentPolicy
{
    ...
    {
        return $this->authorization->canView($user, $shipment)
    ...
    {
        return $shipment->statusValue() === SampleShipment::STATUS_PROCUREMENT_REVIEW
