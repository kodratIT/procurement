...
class ProcurementMasterSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $items = [
            ...
            ['SERAGAM', 'Seragam Jamaah', 'PAKAIAN', 'SET'], ['ATRIBUT', 'Atribut Jamaah', 'PERJALANAN', 'PACK'],
        ...
        $offices = [];
        foreach ([['JKT-01', 'Kantor Pusat Jakarta'], ['SBY-01', 'Kantor Cabang Surabaya']] as [$code,$name]) {
            $offices[$code] = Office::updateOrCreate(['code' => $code], ['name' => $name, 'is_active' => true]);
        }

        DepartureBatch::updateOrCreate(['code' => 'UMR-2026-01'], ['name' => 'Umroh Januari 2026', 'office_id' => $offices['JKT-01']->id, 'departure_date' => '2026-01-15', 'return_date' => '2026-01-27', 'capacity' => 45, 'pax_count' => 42, 'status' => 'closed', 'is_active' => true]);
        DepartureBatch::updateOrCreate(['code' => 'UMR-2026-02'], ['name' => 'Umroh Februari 2026', 'office_id' => $offices['JKT-01']->id, 'departure_date' => '2026-02-12', 'return_date' => '2026-02-24', 'capacity' => 50, 'pax_count' => 37, 'status' => 'open', 'is_active' => true]);
        DepartureBatch::updateOrCreate(['code' => 'UMR-2026-03'], ['name' => 'Umroh Maret 2026 Surabaya', 'office_id' => $offices['SBY-01']->id, 'departure_date' => '2026-03-10', 'return_date' => '2026-03-22', 'capacity' => 40, 'pax_count' => 28, 'status' => 'planned', 'is_active' => true]);
    }
}
